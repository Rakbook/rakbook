...
function doAllSobgo() {
  ...
  c.addEventListener('click', addS, false);
...
function makeFractal(){
  document.getElementById("buttonBar0").style.display = 'none'
  ...
  c.removeEventListener('click', addS, false);
  iter = parseInt(document.getElementById("iterInput").value);
...
function reset(){
  document.getElementById("buttonBar0").style.display = 'block';
